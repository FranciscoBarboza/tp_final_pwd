...
<div class="container col-md-5 text-white mt-5 ">
        ...
        <div class="mb-3">
                ...
                <input class="btn btn-warning mt-2 col-3" type="button" name="boton_editarDatos"  id="boton_editarDatos" value="EDITAR EMAIL">
                <input class="btn btn-warning mt-2 mx-3 col-5" type="button" name="boton_contra"  id="boton_contra" value="CAMBIAR MI CONTRASEÑA">
        </div>
    </div>
