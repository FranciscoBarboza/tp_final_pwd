...
<div class="col-12" style="text-align: end;">
  <button type="button" class="" data-bs-toggle="modal" data-bs-target="#historial_modal">
...
<!-- Modal -->
<div class="modal fade" id="historial_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
